...
4. I don't know about you, but if I have to spend more than 2 minutes on an IVR or automated call line, I immediately start mashing the 0 key so I can talk to a person. Similarly, if they're well designed, chatbots can be a more intuitive form of interaction than a web page or app. From the perspective of the average concerned citizen, it's probably more intuitive to open up Facebook Messenger and report a downed telephone pole to the municipality's chatbot in your native language than it is to use even even the best-designed SeeClickFix system. I  From the perspective of a busy municipality, a chatbot would help answer citizens' questions and free up staff to focus on their work.
