...
4. If they're well designed, chatbots can be a more intuitive form of interaction than a web page or app. From the perspective of a citizen, it's more intuitive to report a downed telephone pole to the municipality's chatbot than it is to . From the perspective of a busy municipality, a chatbot would help answer citizens' questions and free up staff to focus on their work.
