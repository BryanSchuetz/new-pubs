...
*In the interest of both full-disclosure and self-promotion, Digital@DAI would like to thank This is HCD for featuring DAI in the recent episode ['Using a human-centered design approach to design foreign aid programs'.](https://www.thisishcd.com/episodes/24-adam-fiveson-using-a-human-centered-design-approach-to-design-foreign-aid-programs/)*