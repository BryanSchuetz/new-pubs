...
In international development, human-centered design is predicated on a designer's ability to rapidly develop empathy with a marginalized population and a social challenge they face and to use that understanding to develop a localized solution.

Doing so successfully requires one primary skill: **listening.** That means listening in the traditional sense: to an individual, as DAI does in our [Digital Insights](https://dai-global-digital.com/rwanda-digital-insights.html) work; and, more broadly, listening to an entire population to identify social challenges as well as the cultural, political, and economic dynamics that affect them.
