...
Sunbursts are a great way to see hierarchical data all at once and with a little JavaScript we can make them interactive too. Thanks to [D3](https://d3js.org/) this is all easier (and free). This code was derived from [Kenny Roden's work](https://bl.ocks.org/kerryrodden/7090426)
