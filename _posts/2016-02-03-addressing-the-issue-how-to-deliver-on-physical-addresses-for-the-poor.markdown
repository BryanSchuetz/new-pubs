...
The company has sliced the world into 3x3-meter square grids, and assigned each grid square with a unique combination of three words to avoid using GPS coordinates to describe a location. A user can find the unique three-word combination associated with his or her specific location.
