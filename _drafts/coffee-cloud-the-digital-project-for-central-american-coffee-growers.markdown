...
At the regional level, there are different tools that provide solutions to improve coffee growing conditions, but none of them were designed with humans in mind. In Guatemala, DAI opted to create a new tool—**Coffee Cloud**—using a fully human-centered design approach.
